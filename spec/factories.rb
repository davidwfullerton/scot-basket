FactoryGirl.define do
  ...
  factory :item_1, class: Item do
    basket
    association :catalog_entry, factory: :catalog_flag_entry
  end

  factory :item_2, class: Item do
    basket
    association :catalog_entry, factory: :catalog_seat_entry
  end

  factory :item_3, class: Item do
    basket
    association :catalog_entry, factory: :catalog_band_entry
  end
